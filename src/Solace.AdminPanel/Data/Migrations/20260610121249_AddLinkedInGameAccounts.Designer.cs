...
namespace Solace.AdminPanel.Migrations
{
    ...
    [Migration("20260610121249_AddLinkedInGameAccounts")]
    partial class AddLinkedInGameAccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solace.AdminPanel.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Solace.AdminPanel.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Solace.AdminPanel.Models.Db.DbBuildplatePreview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Solace.AdminPanel.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Solace.AdminPanel.Data.ApplicationUser", null)
                        .WithMany()
